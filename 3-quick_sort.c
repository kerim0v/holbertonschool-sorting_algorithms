 ...
 *
 * Description: Selects the element at the high index as pivot, then
 * rearranges the array so that all elements less than or equal to the
 * pivot come before it, and all elements greater than the pivot come
 * after it.
 *
 ...
 * @size: The size of the array.
 *
 * Description: If the low index is less than the high index, selects a
 * pivot using the Lomuto partition scheme, then recursively sorts the
 ...
 * @size: The size of the array.
 *
 * Description: If the array is NULL or the size of the array is less
 * than 2, the function returns without making any changes.
 *
 * Return: This function does not return a value.
 */
